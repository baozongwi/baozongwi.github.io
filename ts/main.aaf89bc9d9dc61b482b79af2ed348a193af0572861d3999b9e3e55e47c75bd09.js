(() => {
  ...
  // ns-hugo-imp:E:\blog\hugostack\themes\hugo-theme-stack\assets\ts\createElement.ts
    ...
    initSwup: () => {
      const checkSwup = () => {
        ...
        try {
          ...
          const SwupSlideTheme = window.SwupSlideTheme;
          const SwupPreloadPlugin = window.SwupPreloadPlugin;
          const SwupProgressPlugin = window.SwupProgressPlugin;
          if (!Swup || !SwupSlideTheme || !SwupPreloadPlugin || !SwupProgressPlugin) {
            console.warn("Some Swup plugins are not available. Check CDN links.");
            return;
          }
          Stack.swup = new Swup({

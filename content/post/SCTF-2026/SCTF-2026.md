...
```
https://calcite.apache.org/docs/adapter.html 帮我解决这道 CTF 题目，打 jdbc 反序列化，参考文章的方法实现 RCE，现在本地的 docker 测试成功，exp 需要写成 production-ready 的干净代码，no comments, no verbose logging。
```
